...
/**
 * Author: Sean Oushana
 * Class Description: Snow State is the class that will be called on by the Context class
 * whenever the state of the page is changed. When Context's request() method is called
 * with "snow" as the parameter, this class's handle method will be executed 
 * @throws IOException
 */
 ...
 */
public class SnowState extends StateOriginator{
   
	/**
	 * Constructor - sets the stateType
	 */
	public SnowState(String dateAndTime) {
		stateType = dateAndTime + ": Snow";
