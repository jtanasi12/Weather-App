...
/**
 * Author: Sean Oushana
 * Class Description: Night State is the class that will be called on by the Context class
 * whenever the state of the page is changed. When Context's request() method is called
 * with "night" as the parameter, this class's handle method will be executed 
 * @throws IOException
 */
 ...
 */
public class NightState extends StateOriginator{
 

	/**
	 * Sets the state to the appropriate name
	 */
	public NightState(String dateAndTime) {
		stateType = dateAndTime + ": Night";
