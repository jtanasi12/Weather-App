...
/**
 * Author: Sean Oushana
 * Class Description: Rain State is the class that will be called on by the Context class
 * whenever the state of the page is changed. When Context's request() method is called
 * with "rain" as the parameter, this class's handle method will be executed 
 * @throws IOException
 */
...
public class RainState extends StateOriginator{
   
	
	/**
	 * @return - returns the stateType.
	 */
	public RainState(String dateAndTime) {
		stateType = dateAndTime + ": Rain";
			}
